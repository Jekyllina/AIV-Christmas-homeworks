...
{
    struct doubly_list_node *node = doubly_list_get_tail_casting(&my_linked_list);
...
{
    struct doubly_list_node *node = doubly_list_pop_casting(&my_linked_list);
...
CLOVE_TEST(GetTailSuccess)
{
    ...
    struct doubly_string_item *tail = (struct doubly_string_item *)doubly_list_get_tail_casting(&my_linked_list);
...
CLOVE_TEST(GetHeadSuccess)
{
    ...
    struct doubly_string_item *head = (struct doubly_string_item *)doubly_list_pop_casting(&my_linked_list);
...
CLOVE_TEST(TakeAnItem)
{
    ...
    struct doubly_string_item *item = (struct doubly_string_item *)doubly_take_list_item_cast(&my_linked_list, 1);

    CLOVE_STRING_EQ("Blue", item->string);
}

CLOVE_TEST(TakeAnItemFail)
{
    struct doubly_string_item *element01 = doubly_string_item_new("Purple");
    struct doubly_string_item *element02 = doubly_string_item_new("Blue");
    ...
    struct doubly_string_item *item = (struct doubly_string_item *)doubly_take_list_item_cast(&my_linked_list, 3);
...
{    
    ...
    int numElementsShuffledList = doubly_take_list_items_count_cast(&shuffledList);

    struct doubly_string_item *item0 = (struct doubly_string_item *)doubly_take_list_item_cast(&shuffledList, 0);
    struct doubly_string_item *item1 = (struct doubly_string_item *)doubly_take_list_item_cast(&shuffledList, 1);
